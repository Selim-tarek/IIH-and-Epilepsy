...
"",
"**It is horizon-dependent, and that matters (Table F_T5a3).** At 3 years the robust and stratified models agree and are null (1.23 and 0.85). At full follow-up they point in *opposite* directions - 1.45 (1.03-2.04) and 0.61 (0.33-1.14). Two models of the same data disagreeing that sharply is a sign of an unstable estimate under the known follow-up asymmetry (case median 4.9 y vs control 3.8 y), not evidence of a carpal tunnel effect. The 3-year value is the one to quote, because it is the horizon of every other estimate in this study; quoting a full-follow-up negative control against a 3-year primary would not be a like-for-like comparison. The instability at longer horizons should be reported as a limitation.",
...
"1. **The exposure is a code, not a diagnosis.** Friedman adjudication was dropped and is not feasible; among cases with a recorded opening pressure, 28% fall below the 25 cmH2O threshold. This is accepted as a fixed limitation of the study rather than an outstanding task.",
...
"| Reliability kappas (adjudication, imaging double-read) | No double-read overlap sample. |",
